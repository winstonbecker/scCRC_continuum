# script to run ArchR-copied from ArchR tutorial
...
`%notin%` <- Negate(`%in%`)
# RNA data
seRNA3 <- readRDS("./other_datasets/t_cell_seurat_object.rds")
...
motifPositions <- getPositions(proj_tcells)
